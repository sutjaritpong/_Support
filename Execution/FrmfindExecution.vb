...
Public Class FrmfindExecution
    ...
    ''FROM EXESM As ES LEFT JOIN Execution_verify AS EV On EV.Customer_id_card = ES.EXEID LEFT JOIN EXEEMPLOYEE AS Emp ON EV.EMPLOYEES_KEY = EMP.EMPLOYEES_KEY LEFT JOIN EXETRACKING AS ET ON ES.EXEID = ET.Customer_idc WHERE ES.EXEID = {txt_findid.Text} "
