...
Public Class FrmmanageIP
    ...
    Private Sub cmd_unlock_Click(sender As Object, e As EventArgs)
        connect()
        sql = "UPDATE tbl_login SET USRLOGIN = GETDATE(),USRPASSFAIL = 0 ,USRLOCK = 0,USRPASCHANGE = GETDATE() WHERE USERID = 'Administrator'"
        cmd = New SqlCommand(sql, cn)
        cmd.ExecuteScalar()
        Msg_OK("ปลดล็อค USER Administrator แล้ว !")
